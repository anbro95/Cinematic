...
@section('content')
    ...
    @if(isset($personalRating))
        @if($personalRating -> value == -1)
            <input type="image" class="like" name="like" src = "{{asset('images/like.png')}}" alt="like" data-filmId="{{$film -> film_id}}">
            <input type="image" class="dislike active-dislike" name="dislike" src="{{asset('images/dislike-active.png')}}" alt="dislike" data-filmId="{{$film -> film_id}}">
        @elseif($personalRating -> value == 1)
            <input type="image" class="like active-like" name="like" src = "{{asset('images/like-active.png')}}" alt="like" data-filmId="{{$film -> film_id}}">
            <input type="image" class="dislike" name="dislike" src="{{asset('images/dislike.png')}}" alt="dislike" data-filmId="{{$film -> film_id}}">
        @else
            <input type="image" class="like" name="like" src = "{{asset('images/like.png')}}" alt="like" data-filmId="{{$film -> film_id}}">
            <input type="image" class="dislike" name="dislike" src="{{asset('images/dislike.png')}}" alt="dislike" data-filmId="{{$film -> film_id}}">
        @endif
    @else
        <input type="image" class="like" name="like" src = "{{asset('images/like.png')}}" alt="like" data-filmId="{{$film -> film_id}}" data-like-value="false">
        <input type="image" class="dislike" name="dislike" src="{{asset('images/dislike.png')}}" alt="dislike" data-filmId="{{$film -> film_id}}" data-dislike-value="false">
    @endif
